...
%  choices are not constant Keep/Give). Duration = reaction time
...
gITIdur=dsgnFile((dsgnFile(:,2)~=-99),8);
gISIdur=dsgnFile((dsgnFile(:,2)~=-99),9);

kOn=dsgnFile((dsgnFile(:,11)~=-99),11);
kDur=dsgnFile((dsgnFile(:,11)~=-99),12);
kFBOn=dsgnFile((dsgnFile(:,11)~=-99),13)-4;
kFBPM=dsgnFile((dsgnFile(:,11)~=-99),14);
kITI=dsgnFile((dsgnFile(:,11)~=-99),15);
kISI=dsgnFile((dsgnFile(:,11)~=-99),16);
kITIdur=dsgnFile((dsgnFile(:,11)~=-99),17);
kISIdur=dsgnFile((dsgnFile(:,11)~=-99),18);

mOn=[];
if size(dsgnFile,2)>16
    mOn=dsgnFile((dsgnFile(:,20)~=-99),20);
    mFBOn=dsgnFile((dsgnFile(:,20)~=-99),21)-4;
    mITI=dsgnFile((dsgnFile(:,20)~=-99),23);
    mISI=dsgnFile((dsgnFile(:,20)~=-99),24);
    mITIdur=dsgnFile((dsgnFile(:,20)~=-99),25);
    mISIdur=dsgnFile((dsgnFile(:,20)~=-99),26);
end
...
matlabbatch{1}.spm.stats.fmri_spec.sess(1).cond(1).duration = gDur;
...
matlabbatch{1}.spm.stats.fmri_spec.sess(1).cond(3).duration = kDur;
...
matlabbatch{3}.spm.stats.con.consess{7}.tcon.name = 'Increasing # of Givers after G';
matlabbatch{3}.spm.stats.con.consess{7}.tcon.weights = [0 0 1 0 0 0];
