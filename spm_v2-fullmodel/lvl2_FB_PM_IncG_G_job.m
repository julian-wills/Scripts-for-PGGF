...
%-----------------------------------------------------------------------
matlabbatch{1}.spm.stats.factorial_design.dir = {'/Users/Julian/GDrive/PGGfMRI/Neuro/Level2Results/wholeMaskL1/ChoiceDur_FB_PM/IncG_G'};
%%
...
for s=1:length(subs)
    ...
    a=dir(d{s});
    for i=1:length(a)
        if strfind(a(i).name,'con_0007')==1 % 1=Give > Keep; 4=Increasing Givers
            b=b+1;
            f{b}=a(i).name;
        end
    end
...
matlabbatch{3}.spm.stats.con.consess{1}.tcon.name = 'Increasing Givers after Give';
matlabbatch{3}.spm.stats.con.consess{1}.tcon.weights = [1];
matlabbatch{3}.spm.stats.con.consess{1}.tcon.sessrep = 'repl';
matlabbatch{3}.spm.stats.con.consess{2}.tcon.name = 'Increasing Givers after Keep';
